        ...
        <div className=' max-w-[1520px] mx-auto w-full'>
            <div className=' w-full grid lg:grid-cols-2'>
                <div className=' flex flex-col mx-auto mt-16 items-center'>
                    <p className=' text-white p-1 font-bold text-center'>NEED ADVICE ON HOW TO IMPROVE OUR FLAWS</p>
                    <p className=' text-white font-semibold text-center'>Sign up to our NewsLetter and stay up-to-date</p>
                ...
                <div className=' flex flex-col mx-auto mt-16 mb-16'>
                    <input
                     placeholder='EMAIL....'
                     className='p-1 rounded-lg w-[300px] focus:outline-none mx-auto'
                    />
                     <button className=' bg-gradient-to-l from-blue-700 to-cyan-600 font-bold text-white w-[150px] rounded-md mx-auto my-6'>
                        NOTIFY ME
                     </button>
                     <p className=' text-white font-semibold text-center'>We are concerned about your data
                         <br></br>
